...
public class CameraUtils {
	 ...
	 * camera/blob/master/camera/src/com/commonsware
	 * /cwac/camera/CameraUtils.java
	 */
	public static void choosePreviewSize(Camera.Parameters parms, int width, int height) {
		...
		for (Camera.Size size : parms.getSupportedPreviewSizes()) {
			Log.i(TAG, "getSupportedPreviewSizes:: width = " + size.width + "  height = " + size.height);
			if (size.width == width && size.height == height) {
				Log.e(TAG, "setPreviewSize::" + width + "x" + height);
		...
		if (ppsfv != null) {
			Log.e(TAG, "setPreviewSize::" + ppsfv.width + "x" + ppsfv.height);
	...
	public static int chooseFixedPreviewFps(Camera.Parameters parms, int desiredThousandFps) {
		...
		Log.i(TAG, "getSupportedPreviewFpsRange size = " + supported.size());
